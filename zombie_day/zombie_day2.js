...
function zombie_day2_setup()
{
    ...
    // {
    //     zombies_day2_wave5[ count5 ] = new zombies();
    // }
...
function zombie_day2_draw()
{
    ...
    if ( zombies_day2_wave1.length <= 15 )
    {
        zombie_day_update( zombies_day2_wave2 );
    }
    //if stage2's zombies and stage1's zombies left 4 then next stage is starting
    if ( zombies_day2_wave1.length + zombies_day2_wave2.length <= 15 )
    {
        zombie_day_update( zombies_day2_wave3 );
    }
    if ( zombies_day2_wave1.length + zombies_day2_wave2.length + zombies_day2_wave3.length <= 15 )
    {
